function CBlock(iX,iY,oSprite,iWidth,iHeight,oParentContainer){
    ...
    this.attachScore = function(iScore,iLevel){
        ...
        var szColorStroke;
        if(iLevel === 1){
            szColor = COLOR_TEXT_SCORE_LV1;
            szColorStroke = COLOR_OUTLINE_SCORE_LV1;
        }else if(iLevel === 2){
            szColor = COLOR_TEXT_SCORE_LV2;
            szColorStroke = COLOR_OUTLINE_SCORE_LV2;
        }else{
            szColor = COLOR_TEXT_SCORE_LV3;
            szColorStroke = COLOR_OUTLINE_SCORE_LV3;
        }
