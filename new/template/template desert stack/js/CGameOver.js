function CGameOver(iX,iY){
	...
	var oSpriteBg = s_oSpriteLibrary.getSprite('msg_box');
        ...
        _oMsgTextStroke = new CTLText(_oContainer, 
                    ...
                    80, "center", COLOR_OUTLINE_GAMEOVER, FONT_GAME, 1,
                    2, 2,
                    TEXT_GAMEOVER,
                    true, true, true,
                    false );
        ...
        _oMsgText = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    80, "center", COLOR_TEXT_GAMEOVER, FONT_GAME, 1,
                    2, 2,
                    TEXT_GAMEOVER,
                    true, true, true,
                    false );
        ...
        _oScoreTextStroke = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    100, "center", COLOR_OUTLINE_GAMEOVER2, FONT_GAME, 1,
                    2, 2,
                    TEXT_SCORE +":\n0",
                    true, true, true,
                    false );
        ...
        _oScoreText = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    100, "center", COLOR_TEXT_GAMEOVER2, FONT_GAME, 1,
                    2, 2,
                    TEXT_SCORE +":\n0",
                    true, true, true,
                    false );
