...
<html>
	...
	<script type="text/javascript" src="js/CWinPanel.js"></script>
        <script type="text/javascript" src="js/CInputPanel.js"></script>
	...
	<div style="position: fixed; background-color: transparent; top: 0px; left: 0px; width: 100%; height: 100%"></div>
        ...
        <input type="text" id="nameInput" style="position:absolute;left: 40%;right:40%;margin: auto;height: 20px; width: 20%; left:43%; height: 3.5%; top:45%;display: none">
        <input type="text" id="phoneInput" style="position:absolute;left: 40%;right:40%;margin: auto;height: 20px; width: 20%; left:43%; height: 3.5%; top:51%;display: none">
        <input type="text" id="emailInput" style="position:absolute;left: 40%;right:40%;margin: auto;height: 20px; width: 20%; left:43%; height: 3.5%; top:57%;display: none">
