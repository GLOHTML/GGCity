function CInterface(){
    ...
    this._init = function(){
        ...
        _oNumScoreStroke = new createjs.Text("0","50px "+FONT_GAME, COLOR_OUTLINE_GAME);
	...
	_oNumScoreStroke.textBaseline  = "alphabetic";
        ...
        _oNumScore = new createjs.Text("0","50px "+FONT_GAME, COLOR_TEXT_GAME);
        _oNumScore.x = 80;
        _oNumScore.y = 50;
	...
	_oNumScore.textBaseline  = "alphabetic";
        ...
        _oLivesTextStroke = new createjs.Text("" ,"50px "+FONT_GAME, COLOR_OUTLINE_GAME);
	...
	_oLivesTextStroke.textBaseline  = "alphabetic";
        ...
        _oLivesText = new createjs.Text("" ,"50px "+FONT_GAME, COLOR_TEXT_GAME);
        _oLivesText.x = 80;
        _oLivesText.y = 110;
	...
	_oLivesText.textBaseline  = "alphabetic";
        ...
        _oNumBlockTextStroke = new createjs.Text(0 ,"60px "+FONT_GAME, COLOR_OUTLINE_GAME);
	...
	_oNumBlockTextStroke.textBaseline  = "middle";
        ...
        _oNumBlockText = new createjs.Text(0 ,"60px "+FONT_GAME, COLOR_TEXT_GAME);
