function CInputPanel(iX,iY){
    ...
    this._init = function(iX,iY){
        ...
        _oMsgTextStroke = new CTLText(_oContainer, 
                    ...
                    80, "center", COLOR_OUTLINE_INPUT_TITLE, FONT_GAME, 1,
                    2, 2,
                    TEXT_GAMEOVER,
                    true, true, true,
                    false );
        ...
        _oMsgText = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    80, "center", COLOR_TEXT_INPUT_TITLE, FONT_GAME, 1,
                    2, 2,
                    TEXT_GAMEOVER,
                    true, true, true,
                    false );
    ...
    _oNameTextStroke = new CTLText(_oContainer, 
                ...
                40, "center", COLOR_OUTLINE_INPUT_LABEL, FONT_GAME, 1.1,
                36, 0,
                "",
                true, true, false,
                false );
    ...
    _oNameText = new CTLText(_oContainer, 
                ...
                40, "center", COLOR_TEXT_INPUT_LABEL, FONT_GAME, 1.1,
                50, 0,
                "",
                true, true, false,
                false );
