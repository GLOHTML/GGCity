function CHelpPanel(oParentContainer){
    ...
    this._init = function(){
        ...
        _oTextStroke1 = new CTLText(_oContainer, 
                    ...
                    60, "center", COLOR_OUTLINE_HELP, FONT_GAME, 0.8,
                    2, 2,
                    TEXT_HELP1,
                    true, true, true,
                    false );
        ...
        _oText1 = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    60, "center", COLOR_TEXT_HELP, FONT_GAME, 0.8,
                    2, 2,
                    TEXT_HELP1,
                    true, true, true,
                    false );
        ...
        _oTextStroke2 = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    60, "center", COLOR_OUTLINE_HELP2, FONT_GAME, 0.8,
                    2, 2,
                    TEXT_HELP2,
                    true, true, true,
                    false );
        ...
        _oText2 = new CTLText(_oContainer, 
                    iTextX -iWidth/2, iTextY - iHeight/2, iWidth, iHeight, 
                    60, "center", COLOR_TEXT_HELP2, FONT_GAME, 0.8,
                    2, 2,
                    TEXT_HELP2,
                    true, true, true,
                    false );
